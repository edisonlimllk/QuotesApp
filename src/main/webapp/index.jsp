    ...
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                ...
                <li><a href="hello-servlet" class="nav-link px-2 text-white">Features</a></li>
            ...
            <div class="text-end">
                ...
                <button type="button" class="btn btn-warning" onclick="window.location=register.jsp">Sign-up</button>
            </div>
        </div>
    </div>
</header>
